...
$(document).ready(function () {
	...
	// AUTODESPLIEGUE DEL PANEL DE LIMITES DE CATEGORIAS
	 $('.alert-limit-categories .checkbox-content').on('click', function() {
		 var $submodule = $(this).closest('.fila-alert').find('.submodule');
		 if ($submodule.hasClass("slideup")) {
			 $submodule.removeClass("slideup").addClass("slidedown");
	     }
	...
	// EDIT VALUE FROM ALERT AND SUBALERT
     $('.edit-money, .edit-subalert').on('click', function() {
         changeEditButton($(this), false);
     });

     // CONFIRM EDIT
     $('.check-money, .check-subalert').on('click', function(event){
     ...
     // HOVER CHECK
     $('.content-presupuestos').find('.check-money, .check-subalert').hover (
         function() {
