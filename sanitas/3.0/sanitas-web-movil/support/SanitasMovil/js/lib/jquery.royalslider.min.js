...
a.st.thumbs.spacing),a.ev.on("rsBeforeParseNode",function(a,c,b){c=f(c);b.thumbnail=c.find(".rsTmb").remove();b.thumbnail.length?b.thumbnail=f(document.createElement("div")).append(b.thumbnail).html():(b.thumbnail=c.attr("data-rsTmb"),b.thumbnail||(b.thumbnail=c.find(".rsImg").attr("data-rsTmb")),b.thumbnail=b.thumbnail?'<img src="../../../js/lib/'+b.thumbnail+'"/>':"")}),a.ev.one("rsAfterPropsSetup",function(){a._l6()}),a._o5=null,a.ev.on("rsOnUpdateNav",function(){var e=f(a._m5[a.currSlideId]);e!==a._o5&&(a._o5&&
...
!a.isLoaded&&!a.isLoading?'<a class="rsImg rsMainSlideImage" href="../../../js/lib/'+a.image+'"></a>':'<img class="rsImg rsMainSlideImage" src="../../../js/lib/'+a.image+'"/>';a.content.hasClass("rsImg")?a.content=c(b):a.content.find(".rsImg").eq(0).replaceWith(b);!a.isLoaded&&(!a.isLoading&&a.holder)&&a.holder.html(a.content)}});c.rsModules.fullscreen=c.rsProto._r5})(jQuery);
