...
var _ugifpath="../../../../../../stats/__utm.gif";	// set the web path to the __utm.gif file
var _utsp="|";			// transaction field separator
var _uflash=1;			// set flash version detect option (1=on|0=off)
var _utitle=1;			// set the document title detect option (1=on|0=off)
var _ulink=0;			// enable linker functionality (1=on|0=off)
var _uanchor=0;			// enable use of anchors for campaign (1=on|0=off)
var _utcp="http://www.sanitas.es/";			// the cookie path for tracking
...
if (_udl.protocol=="index.html") _ugifpath2="../../../../../../../ssl.google-analytics.com/__utm.gif";
if (!_utcp || _utcp=="") _utcp="http://www.sanitas.es/";
...
function _uInfo(page) {
 ...
 if (!_ur || _ur=="") { _ur="-"; }
  ...
  dm=_ubd.domain;
  if(_utcp && _utcp!="http://www.sanitas.es/") dm+=_utcp;
  p=_ur.indexOf(dm);
  if ((p>=0) && (p<=8)) { _ur="0"; }
...
function _uRef() {
 ...
 if (h.indexOf("http://www.sanitas.es/") > -1) {
  k=h.substring(h.indexOf("http://www.sanitas.es/"),h.length);
  if (k.indexOf("?") > -1) k=k.substring(0,k.indexOf("?"));
  h=h.substring(0,h.indexOf("http://www.sanitas.es/"));
 }
 h=h.toLowerCase();
 n=h;
...
function _uGCse() {
 ...
 h=p=_ur.split("://")[1];
 if(h.indexOf("http://www.sanitas.es/")>-1) {
  h=h.split("http://www.sanitas.es/")[0];
  p=p.substring(p.indexOf("http://www.sanitas.es/")+1,p.length);
 }
 if(p.indexOf("?")>-1) {
  p=p.split("?")[0];
 }
