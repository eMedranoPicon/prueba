...
}if(c=$P(c)){if(a.insertion){if(Object.isString(a.insertion)){var b={};
b[a.insertion]=d;
c.insert(b)
...
function $P(b){if(arguments.length>1){for(var a=0,d=[],c=arguments.length;
a<c;
a++){d.push($P(arguments[a]))
}return d
}if(Object.isString(b)){b=document.getElementById(b)
}return Element.extend(b)
}if(Prototype.BrowserFeatures.XPath){document._getElementsByXPath=function(f,a){var c=[];
var e=document.evaluate(f,$P(a)||document,null,XPathResult.ORDERED_NODE_SNAPSHOT_TYPE,null);
...
Element.cache={};
Element.Methods={visible:function(a){return $P(a).style.display!="none"
},toggle:function(a){a=$P(a);
Element[Element.visible(a)?"hide":"show"](a);
return a
},hide:function(a){$P(a).style.display="none";
return a
},show:function(a){$P(a).style.display="";
return a
},remove:function(a){a=$P(a);
a.parentNode.removeChild(a);
return a
},update:function(a,b){a=$P(a);
...
},wrap:function(b,c,a){b=$P(b);
if(Object.isElement(c)){$P(c).writeAttribute(a||{})
}else{if(Object.isString(c)){c=new Element(c,a)
}else{c=new Element("div",c)
}}if(b.parentNode){b.parentNode.replaceChild(c,b)
}c.appendChild(b);
return c
},inspect:function(b){b=$P(b);
...
return a+">"
},recursivelyCollect:function(a,c){a=$P(a);
var b=[];
while(a=a[c]){if(a.nodeType==1){b.push(Element.extend(a))
}}return b
},ancestors:function(a){return $P(a).recursivelyCollect("parentNode")
},descendants:function(a){return $P(a).select("*")
},firstDescendant:function(a){a=$P(a).firstChild;
while(a&&a.nodeType!=1){a=a.nextSibling
}return $P(a)
},immediateDescendants:function(a){if(!(a=$P(a).firstChild)){return[]
}while(a&&a.nodeType!=1){a=a.nextSibling
}if(a){return[a].concat($P(a).nextSiblings())
}return[]
},previousSiblings:function(a){return $P(a).recursivelyCollect("previousSibling")
},nextSiblings:function(a){return $P(a).recursivelyCollect("nextSibling")
},siblings:function(a){a=$P(a);
return a.previousSiblings().reverse().concat(a.nextSiblings())
},match:function(b,a){if(Object.isString(a)){a=new Selector(a)
}return a.match($P(b))
},up:function(b,d,a){b=$P(b);
if(arguments.length==1){return $P(b.parentNode)
}var c=b.ancestors();
return Object.isNumber(d)?c[d]:Selector.findElement(c,d,a)
},down:function(b,c,a){b=$P(b);
if(arguments.length==1){return b.firstDescendant()
}return Object.isNumber(c)?b.descendants()[c]:b.select(c)[a||0]
},previous:function(b,d,a){b=$P(b);
if(arguments.length==1){return $P(Selector.handlers.previousElementSibling(b))
}var c=b.previousSiblings();
return Object.isNumber(d)?c[d]:Selector.findElement(c,d,a)
},next:function(c,d,b){c=$P(c);
if(arguments.length==1){return $P(Selector.handlers.nextElementSibling(c))
}var a=c.nextSiblings();
return Object.isNumber(d)?a[d]:Selector.findElement(a,d,b)
},select:function(){var a=$A(arguments),b=$P(a.shift());
return Selector.findChildElements(b,a)
},adjacent:function(){var a=$A(arguments),b=$P(a.shift());
return Selector.findChildElements(b.parentNode,a).without(b)
},identify:function(b){b=$P(b);
...
return c
},readAttribute:function(c,a){c=$P(c);
...
},writeAttribute:function(e,c,f){e=$P(e);
...
},getHeight:function(a){return $P(a).getDimensions().height
},getWidth:function(a){return $P(a).getDimensions().width
},classNames:function(a){return new Element.ClassNames(a)
},hasClassName:function(a,b){if(!(a=$P(a))){return
}var c=a.className;
return(c.length>0&&(c==b||new RegExp("(^|\\s)"+b+"(\\s|$)").test(c)))
},addClassName:function(a,b){if(!(a=$P(a))){return
}if(!a.hasClassName(b)){a.className+=(a.className?" ":"")+b
}return a
},removeClassName:function(a,b){if(!(a=$P(a))){return
}a.className=a.className.replace(new RegExp("(^|\\s+)"+b+"(\\s+|$)")," ").strip();
return a
},toggleClassName:function(a,b){if(!(a=$P(a))){return
}return a[a.hasClassName(b)?"removeClassName":"addClassName"](b)
},cleanWhitespace:function(b){b=$P(b);
var c=b.firstChild;
while(c){var a=c.nextSibling;
if(c.nodeType==3&&!/\S/.test(c.nodeValue)){b.removeChild(c)
}c=a
}return b
},empty:function(a){return $P(a).innerHTML.blank()
},descendantOf:function(f,d){f=$P(f),d=$P(d);
var h=d;
...
},scrollTo:function(a){a=$P(a);
var b=a.cumulativeOffset();
window.scrollTo(b[0],b[1]);
return a
},getStyle:function(b,c){b=$P(b);
...
},getOpacity:function(a){return $P(a).getStyle("opacity")
},setStyle:function(b,c){b=$P(b);
var e=b.style,a;
...
},setOpacity:function(a,b){a=$P(a);
a.style.opacity=(b==1||b==="")?"":(b<0.00001)?0:b;
return a
},getDimensions:function(c){c=$P(c);
var g=$P(c).getStyle("display");
...
},makePositioned:function(a){a=$P(a);
...
},undoPositioned:function(a){a=$P(a);
if(a._madePositioned){a._madePositioned=undefined;
a.style.position=a.style.top=a.style.left=a.style.bottom=a.style.right=""
}return a
},makeClipping:function(a){a=$P(a);
if(a._overflow){return a
}a._overflow=Element.getStyle(a,"overflow")||"auto";
if(a._overflow!=="hidden"){a.style.overflow="hidden"
}return a
},undoClipping:function(a){a=$P(a);
if(!a._overflow){return a
...
return Element._returnOffset(c,a)
},getOffsetParent:function(a){if(a.offsetParent){return $P(a.offsetParent)
}if(a==document.body){return $P(a)
}while((a=a.parentNode)&&a!=document.body){if(Element.getStyle(a,"position")!="static"){return $P(a)
...
var f=[0,0];
var c=null;
if(Element.getStyle(b,"position")=="absolute"){if(d.parentNode){c=d.getOffsetParent();
f=c.viewportOffset()
...
}else{if(Prototype.Browser.IE){Element.Methods.getOffsetParent=Element.Methods.getOffsetParent.wrap(function(c,b){b=$P(b);
...
$w("positionedOffset viewportOffset").each(function(a){Element.Methods[a]=Element.Methods[a].wrap(function(e,c){c=$P(c);
...
Element.Methods.getStyle=function(a,b){a=$P(a);
...
},_flag:function(a,b){return $P(a).hasAttribute(b)?b:null
...
}else{if(Prototype.Browser.Gecko&&/rv:1\.8\.0/.test(navigator.userAgent)){Element.Methods.setOpacity=function(a,b){a=$P(a);
a.style.opacity=(b==1)?0.999999:(b==="")?"":(b<0.00001)?0:b;
return a
}
}else{if(Prototype.Browser.WebKit){Element.Methods.setOpacity=function(a,b){a=$P(a);
a.style.opacity=(b==1||b==="")?"":(b<0.00001)?0:b;
...
}}}}if(Prototype.Browser.IE||Prototype.Browser.Opera){Element.Methods.update=function(b,c){b=$P(b);
if(c&&c.toElement){c=c.toElement()
...
}if("outerHTML" in document.createElement("div")){Element.Methods.replace=function(c,e){c=$P(c);
...
}},id:function(b,a,j,f){var g=$P(j),d=Selector.handlers;
if(!g){return[]
...
return a
},matchElements:function(f,g){var e=$$P(g),d=Selector.handlers;
d.mark(e);
for(var c=0,b=[],a;
a=f[c];
...
}function $$P(){return Selector.findChildElements(document,$A(arguments))
}var Form={reset:function(a){$P(a).reset();
return a
...
},getElements:function(a){return $A($P(a).getElementsByTagName("*")).inject([],function(b,c){if(Form.Element.Serializers[c.tagName.toLowerCase()]){b.push(Element.extend(c))
}return b
})
},getInputs:function(g,c,d){g=$P(g);
...
},disable:function(a){a=$P(a);
Form.getElements(a).invoke("disable");
return a
},enable:function(a){a=$P(a);
Form.getElements(a).invoke("enable");
return a
},findFirstElement:function(b){var c=$P(b).getElements().findAll(function(d){return"hidden"!=d.type&&!d.disabled
});
...
},focusFirstElement:function(a){a=$P(a);
a.findFirstElement().activate();
return a
},request:function(b,a){b=$P(b),a=Object.clone(a||{});
...
Form.Element={focus:function(a){$P(a).focus();
return a
},select:function(a){$P(a).select();
return a
}};
Form.Element.Methods={serialize:function(a){a=$P(a);
if(!a.disabled&&a.name){var b=a.getValue();
if(b!=undefined){var c={};
c[a.name]=b;
return Object.toQueryString(c)
}}return""
},getValue:function(a){a=$P(a);
var b=a.tagName.toLowerCase();
return Form.Element.Serializers[b](a)
},setValue:function(a,b){a=$P(a);
var c=a.tagName.toLowerCase();
Form.Element.Serializers[c](a,b);
return a
},clear:function(a){$P(a).value="";
return a
},present:function(a){return $P(a).value!=""
},activate:function(a){a=$P(a);
try{a.focus();
...
Abstract.EventObserver=Class.create({initialize:function(a,b){this.element=$P(a);
this.callback=b;
this.lastValue=this.getValue();
...
}return{observe:function(l,j,m){l=$P(l);
var k=g(j);
var n=h(l,j,m);
if(!n){return l
...
},stopObserving:function(l,j,m){l=$P(l);
var o=c(l),k=g(j);
...
$P("__onDOMContentLoaded").onreadystatechange=function(){if(this.readyState=="complete"){this.onreadystatechange=null;
a()
}}
}})();
...
if(!h&&!f){return g
}var c=$P(e).getElementsByTagName("*");
f=" "+f+" ";
for(var d=0,k,j;
k=c[d];
...
return function(d,c){return $P(c||document.body).getElementsByClassName(d)
}
}(Element.Methods)
}Element.ClassNames=Class.create();
Element.ClassNames.prototype={initialize:function(a){this.element=$P(a)
