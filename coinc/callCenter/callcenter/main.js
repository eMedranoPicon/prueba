...
//	});
	...
	$('#headHistoricoMenu').mouseleave(function () {
		$(this).find('ul li ul li a').css({
	...
	$('.folder-wrapper').click(function() {
		$(this).closest('ul').closest('li').find('ul li ul li a').css({
			"transition": "all 1s ease",
			"height": "0",
			"padding": "0 22px"
	    });
		
		$(this).closest('li').find('ul li a').css({
		      "height": "35px",
...
//		if ($(this).closest('li').find('input:checkbox').is(':checked')) {
//			
//		} else {
//			
//		}
